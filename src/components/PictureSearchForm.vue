  ...
  <div class="picture-search-form">
    ...
    <a-form name="searchForm" layout="inline" :model="searchParams" @finish="doSearch">
      ...
      <a-form-item name="category" label="分类">
        <a-auto-complete v-model:value="searchParams.category" style="min-width: 180px" placeholder="请输入分类"
          :options="categoryOptions" allow-clear />
      </a-form-item>
      <a-form-item name="tags" label="标签">
        <a-select v-model:value="searchParams.tags" style="min-width: 180px" mode="tags" placeholder="请输入标签"
      ...
      <a-form-item>
        <a-space>
          ...
          <a-button type="link" @click="toggleAdvanced">
            {{ showAdvanced ? '收起' : '展开' }}
            <template #icon><down-outlined :rotate="showAdvanced ? 180 : 0" /></template>
          </a-button>
        </a-space>
      </a-form-item>
      ...
      <div class="advanced-search" v-show="showAdvanced">
        ...
        <div class="advanced-search-content">
          <a-form-item label="日期" name="dateRange">
            <a-range-picker style="width: 400px" show-time v-model:value="dateRange" :placeholder="['编辑开始时间', '编辑结束时间']"
...
.advanced-search-content .ant-form-item {
  margin-right: 16px;
}
</style>