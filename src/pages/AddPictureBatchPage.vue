<template>
  <div id="addPictureBatchPage">
    ...
    <a-form name="formData" layout="vertical" :model="formData" @finish="handleSubmit">
      ...
      <a-form-item name="source" label="图片源">
        <a-select v-model:value="formData.source" placeholder="请选择图片源">
          <a-select-option :value="0">Bing源</a-select-option>
          <a-select-option :value="1">Pexels源</a-select-option>
        </a-select>
      </a-form-item>
      <a-form-item>
